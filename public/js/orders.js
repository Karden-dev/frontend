...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const renderOrdersTable = (orders) => {
        ...
        orders.forEach(order => {
            ...
            let payoutAmount = 0;
            // La logique de calcul du montant à verser est maintenant corrigée
    ...
    // Le reste du fichier est identique, car il gère principalement l'interface et les interactions
    // qui n'ont pas besoin d'être modifiées.
