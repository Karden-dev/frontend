...
const fetchAndRenderUsers = async () => {
    try {
        ...
        // CORRECTION API: Utilisation d'un remplacement pour contrer le préfixe 'api/' si l'environnement le force, tout en utilisant le chemin correct /users
        const urlParamsString = params.toString().replace('api/', '');
        const response = await axios.get(`${API_BASE_URL}/users?${urlParamsString}`);
